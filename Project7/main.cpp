...
void TVD(double dx, double dy, double dt)
{
    ...
    double (*rou)[Ny + 2] = new double[Nx + 2][Ny + 2];
    double(*u)[Ny + 2] = new double[Nx + 2][Ny + 2];
    double(*v)[Ny + 2] = new double[Nx + 2][Ny + 2];
    double(*p)[Ny + 2] = new double[Nx + 2][Ny + 2];
    double(*c)[Ny + 2] = new double[Nx + 2][Ny + 2];
    double(*H)[Ny + 2] = new double[Nx + 2][Ny + 2];
